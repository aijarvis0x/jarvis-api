...
const categories = [
    { id: 1, value: "ai-detector", label: "AI Detector", icon: "/icon/id-con.svg" },
    { id: 2, value: "blog-writer", label: "Blog Writer", icon: "/icon/id-con.svg" },
    { id: 3, value: "ideas", label: "Ideas", icon: "/icon/id-con.svg" },
